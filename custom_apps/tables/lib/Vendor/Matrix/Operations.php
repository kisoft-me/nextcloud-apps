...
namespace OCA\Tables\Vendor\Matrix;

use OCA\Tables\Vendor\Matrix\Operators\Addition;
use OCA\Tables\Vendor\Matrix\Operators\DirectSum;
use OCA\Tables\Vendor\Matrix\Operators\Division;
use OCA\Tables\Vendor\Matrix\Operators\Multiplication;
use OCA\Tables\Vendor\Matrix\Operators\Subtraction;
/** @internal */
class Operations
{
