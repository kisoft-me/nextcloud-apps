...
namespace OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls;

use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Cell\Coordinate;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xls;
...
class Escher
{
     ...
     * @var T
     */
    private BSE|BstoreContainer|DgContainer|DggContainer|\OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher|SpContainer|SpgrContainer $object;
    /**
     * Create a new Escher instance.
     *
     * @param T $object
     */
    public function __construct(BSE|BstoreContainer|DgContainer|DggContainer|\OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher|SpContainer|SpgrContainer $object)
    {
        $this->object = $object;
    }
     ...
     * @return T
     */
    public function load(string $data) : BSE|BstoreContainer|DgContainer|DggContainer|\OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher|SpContainer|SpgrContainer
    {
        $this->data = $data;
