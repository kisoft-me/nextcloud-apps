...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx\Styles as StyleReader;
...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalFormatValueObject;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\ConditionalIconSet;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting\IconSetValues;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\Style as Style;
...
class ConditionalStyles
{
    ...
    public function loadFromExt() : void
    {
        ...
        $this->setConditionalsFromExt($this->readConditionalsFromExt($this->worksheetXml->extLst));
        $this->worksheet->setSelectedCells($selectedCells);
    }
    ...
    private function readStyleRules(array $cfRules, SimpleXMLElement $extLst) : array
    {
        ...
        foreach ($cfRules as $cfRule) {
            ...
            if (isset($cfRule->dataBar)) {
                ...
                $objConditional->setColorScale($this->readColorScale($cfRule));
