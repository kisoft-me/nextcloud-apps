...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\Axis;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\AxisText;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\ChartColor;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeries;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\DataSeriesValues;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\GridLines;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\Layout;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\Legend;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\PlotArea;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\Properties as ChartProperties;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\Title;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\TrendLine;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Reader\Xlsx;
...
class Chart
{
    ...
    public function readChart(SimpleXMLElement $chartElements, string $chartName) : \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\Chart
    {
        ...
        $chart = new \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\Chart($chartName, $title, $legend, $plotArea, $plotVisOnly, (string) $dispBlanksAs, $XaxisLabel, $YaxisLabel, $xAxis, $yAxis);
        if ($chartNoFill) {
            $chart->setNoFill(\true);
        }
    ...
    private function setAxisProperties(SimpleXMLElement $chartDetail, ?Axis $whichAxis) : void
    {
        ...
        if (isset($chartDetail->numFmt)) {
            $whichAxis->setAxisNumberProperties((string) self::getAttributeString($chartDetail->numFmt, 'formatCode'), null, (int) self::getAttributeInteger($chartDetail->numFmt, 'sourceLinked'));
        }
