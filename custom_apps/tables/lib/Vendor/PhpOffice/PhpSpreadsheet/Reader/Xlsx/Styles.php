...
class Styles extends BaseParserClass
{
    ...
    public function readFillStyle(Fill $fillStyle, SimpleXMLElement $fillStyleXml) : void
    {
        if ($fillStyleXml->gradientFill) {
            ...
            if (!$fgFound && !\in_array($patternType, [Fill::FILL_NONE, Fill::FILL_SOLID], \true) && $fillStyle->getStartColor()->getARGB()) {
                $fillStyle->getStartColor()->setARGB('', \true);
            }
            if (!$bgFound && !\in_array($patternType, [Fill::FILL_NONE, Fill::FILL_SOLID], \true) && $fillStyle->getEndColor()->getARGB()) {
                $fillStyle->getEndColor()->setARGB('', \true);
            }
        }
    }
