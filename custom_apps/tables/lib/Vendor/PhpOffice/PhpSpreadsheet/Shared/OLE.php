...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE\ChainedBlockStream;
...
class OLE
{
    ...
    private function ppsTreeComplete(int $index) : bool
    {
        ...
        return ($pps->PrevPps == -1 || $this->ppsTreeComplete($pps->PrevPps)) && ($pps->NextPps == -1 || $this->ppsTreeComplete($pps->NextPps)) && ($pps->DirPps == -1 || $this->ppsTreeComplete($pps->DirPps));
    }
    /**
