...
abstract class BestFit
{
     ...
     */
    public abstract function getValueOfYForX(float $xValue) : float;
    /**
     ...
     */
    public abstract function getValueOfXForY(float $yValue) : float;
    /**
     ...
     */
    public abstract function getEquation(int $dp = 0) : string;
    /**
    ...
    {
        return \array_sum(\array_map(fn($value): float|int => $value ** 2, $values));
    }
    /**
     * @param float[] $yValues
     * @param float[] $xValues
