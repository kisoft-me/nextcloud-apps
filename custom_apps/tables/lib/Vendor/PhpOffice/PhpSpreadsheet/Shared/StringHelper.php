...
class StringHelper
{
     ...
     */
    public static function convertToString(mixed $value, bool $throw = \true, string $default = '', bool $convertBool = \false, bool $lessFloatPrecision = \false) : string
    {
    ...
    {
        if (\function_exists('OCA\\Tables\\Vendor\\str_increment')) {
