...
namespace OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Database;

use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Information\ExcelError;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Maximum;
/** @internal */
class DMax extends DatabaseAbstract
{
     ...
     *                                        column.
     */
    public static function evaluate(array $database, array|null|int|string $field, array $criteria, bool $returnError = \true) : null|float|string
    {
