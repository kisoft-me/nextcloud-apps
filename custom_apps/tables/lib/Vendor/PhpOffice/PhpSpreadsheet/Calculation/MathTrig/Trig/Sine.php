...
namespace OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Trig;
...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\MathTrig\Helpers;
/** @internal */
class Sine
{
    use ArrayEnabled;
