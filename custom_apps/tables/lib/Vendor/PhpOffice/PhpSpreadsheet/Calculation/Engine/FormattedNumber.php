...
namespace OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engine;
...
class FormattedNumber
{
    ...
    {
        return self::convertToNumberIfNumeric($operand) || self::convertToNumberIfFraction($operand) || self::convertToNumberIfPercent($operand) || self::convertToNumberIfCurrency($operand);
    }
    /**
