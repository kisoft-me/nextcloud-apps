...
namespace OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\DateTimeExcel;
...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Date as SharedDateHelper;
use Throwable;
/** @internal */
class Helpers
{
     ...
     */
    public static function getDateValue(mixed $dateValue, bool $allowBool = \true) : float
    {
     ...
     */
    public static function nullFalseTrueToNumber(mixed &$number, bool $allowBool = \true) : void
    {
