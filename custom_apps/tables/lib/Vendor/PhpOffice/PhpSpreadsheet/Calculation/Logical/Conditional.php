...
namespace OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Logical;
...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Information\Value;
/** @internal */
class Conditional
{
    use ArrayEnabled;
     ...
     */
    public static function statementIf(mixed $condition = \true, mixed $returnIfTrue = 0, mixed $returnIfFalse = \false) : mixed
    {
