...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engine\ArrayArgumentHelper;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Engine\ArrayArgumentProcessor;
/** @internal */
trait ArrayEnabled
{
    private static bool $initializationNeeded = \true;
    ...
    {
        if (self::$initializationNeeded === \true) {
