...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\IComparable;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Drawing\Shadow;
...
class BaseDrawing implements IComparable
{
     ...
     * Proportional resize.
     */
    protected bool $resizeProportional = \true;
    /**
     * Rotation.
     */
    ...
    {
        return \md5($this->name . $this->description . ($this->worksheet === null ? '' : (string) \spl_object_id($this->worksheet)) . $this->coordinates . $this->offsetX . $this->offsetY . $this->coordinates2 . $this->offsetX2 . $this->offsetY2 . $this->width . $this->height . $this->rotation . $this->shadow->getHashCode() . __CLASS__);
    }
    /**
