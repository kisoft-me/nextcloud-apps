...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Internal\WildcardMatch;
...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Cell\CellRange;
    ...
    public function showHideRows() : static
    {
        ...
        for ($row = $rangeStart[1] + 1; $row <= $rangeEnd[1]; ++$row) {
            ...
            foreach ($columnFilterTests as $columnID => $columnFilterTest) {
                ...
                /** @var bool */
                $result = \call_user_func_array($temp, [$cellValue, $columnFilterTest['arguments']]);
