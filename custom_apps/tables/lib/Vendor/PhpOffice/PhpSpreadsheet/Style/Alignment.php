...
class Alignment extends Supervisor
{
    ...
    public function getHashCode() : string
    {
        ...
        return \md5($this->horizontal . ($this->justifyLastLine === null ? 'null' : ($this->justifyLastLine ? 't' : 'f')) . $this->vertical . $this->textRotation . ($this->wrapText ? 't' : 'f') . ($this->shrinkToFit ? 't' : 'f') . $this->indent . $this->readOrder . __CLASS__);
    }
    /** @return mixed[] */
