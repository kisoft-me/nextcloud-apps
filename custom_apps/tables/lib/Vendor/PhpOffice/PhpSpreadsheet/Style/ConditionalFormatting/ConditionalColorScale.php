...
namespace OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\ConditionalFormatting;

use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Calculation\Statistical\Percentiles;
...
class ConditionalColorScale
{
    ...
    private ?\OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet = null;
    ...
    public function setSqRef(string $sqref, \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet) : self
    {
        $this->sqref = $sqref;
    ...
    public function setScaleArray() : self
    {
        if ($this->sqref !== null && $this->worksheet !== null) {
            $values = $this->worksheet->rangesToArray($this->sqref, null, \true, \true, \true);
            $this->valueArray = [];
