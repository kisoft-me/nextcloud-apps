...
abstract class Supervisor implements IComparable
{
     ...
     */
    protected final function exportArray2(array &$exportedArray, string $index, mixed $objOrValue) : void
    {
     ...
     */
    public abstract function getSharedComponent() : mixed;
    /**
     ...
     * @return mixed[]
     */
    public abstract function getStyleArray(array $array) : array;
}
