...
class Font
{
     ...
     * Font.
     */
    private \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\Font $font;
    /**
     * Constructor.
     */
    public function __construct(\OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\Font $font)
    {
    ...
    public function writeFont() : string
    {
        ...
        $bFamily = 0;
        // Font family
        $bCharSet = \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Font::getCharsetFromFontName((string) $this->font->getName());
        // Character set
        $record = 0x31;
        // Record identifier
        $reserved = 0x0;
     ...
     * @var int[]
     */
    private static array $mapUnderline = [\OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_NONE => 0x0, \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLE => 0x1, \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLE => 0x2, \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_SINGLEACCOUNTING => 0x21, \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\Font::UNDERLINE_DOUBLEACCOUNTING => 0x22];
    /**
     * Map underline.
     */
