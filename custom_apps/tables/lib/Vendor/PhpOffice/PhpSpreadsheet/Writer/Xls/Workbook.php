...
class Workbook extends BIFFwriter
{
     ...
     */
    public function addFont(\OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\Font $font) : int
    {
    ...
    private function parseDefinedNameValue(DefinedName $definedName) : string
    {
        ...
        $splitCount = Preg::matchAllWithOffsets('/' . Calculation::CALCULATION_REGEXP_CELLREF . '/mui', $definedRange, $splitRanges);
     ...
     */
    private function writeBoundSheet(\OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $sheet, int $offset) : void
    {
        $sheetname = $sheet->getTitle();
        $record = 0x85;
        // Record identifier
        $ss = match ($sheet->getSheetState()) {
            \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VISIBLE => 0x0,
            \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_HIDDEN => 0x1,
            \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet::SHEETSTATE_VERYHIDDEN => 0x2,
            default => 0x0,
        };
        // sheet type
        $st = 0x0;
    ...
    private function writeDateMode() : void
    {
        ...
        $length = 0x2;
        // Bytes to follow
        $f1904 = $this->spreadsheet->getExcelCalendar() === Date::CALENDAR_MAC_1904 ? 1 : 0;
