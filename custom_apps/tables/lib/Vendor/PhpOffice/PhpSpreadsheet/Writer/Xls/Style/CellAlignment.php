...
namespace OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Style;
...
class CellAlignment
{
     ...
     */
    private static array $horizontalMap = [Alignment::HORIZONTAL_GENERAL => 0, Alignment::HORIZONTAL_LEFT => 1, Alignment::HORIZONTAL_RIGHT => 3, Alignment::HORIZONTAL_CENTER => 2, Alignment::HORIZONTAL_CENTER_CONTINUOUS => 6, Alignment::HORIZONTAL_JUSTIFY => 5];
    /**
     * @var array<string, int>
     */
    private static array $verticalMap = [Alignment::VERTICAL_BOTTOM => 2, Alignment::VERTICAL_TOP => 0, Alignment::VERTICAL_CENTER => 1, Alignment::VERTICAL_JUSTIFY => 3];
