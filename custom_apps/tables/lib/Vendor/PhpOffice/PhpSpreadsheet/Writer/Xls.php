...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DgContainer\SpgrContainer\SpContainer;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Escher\DggContainer\BstoreContainer\BSE\Blip;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS\File;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\OLE\PPS\Root;
...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Parser;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Workbook;
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Writer\Xls\Worksheet;
/** @internal */
        ...
        for ($i = 0; $i < $countSheets; ++$i) {
            foreach ($this->writerWorksheets[$i]->phpSheet->getCellCollection()->getCoordinates() as $coordinate) {
                ...
                if ($cVal instanceof RichText) {
                    ...
                    if ($active > -1) {
                        $this->spreadsheet->setActiveSheetIndex($active);
                    }
    ...
    private function buildWorksheetEschers() : void
    {
        ...
        foreach ($this->spreadsheet->getAllsheets() as $sheet) {
            ...
            foreach ($sheet->getDrawingCollection() as $drawing) {
                ...
                $twoAnchor = \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Shared\Xls::oneAnchor2twoAnchor($sheet, $coordinates, $offsetX, $offsetY, $width, $height);
