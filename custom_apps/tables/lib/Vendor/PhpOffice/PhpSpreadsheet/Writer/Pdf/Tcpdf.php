...
class Tcpdf extends Pdf
{
     ...
     */
    protected function createExternalWriterInstance(string $orientation, string $unit, $paperSize) : \OCA\Tables\Vendor\TCPDF
    {
        $this->defines();
        return new \OCA\Tables\Vendor\TCPDF($orientation, $unit, $paperSize);
    }
