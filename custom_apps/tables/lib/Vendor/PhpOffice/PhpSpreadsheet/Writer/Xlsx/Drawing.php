...
class Drawing extends WriterPart
{
     ...
     */
    public function writeDrawings(\OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet, bool $includeCharts = \false) : string
    {
        // Create XML writer
        $objWriter = null;
     ...
     * Write drawings to XML format.
     */
    public function writeChart(XMLWriter $objWriter, \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Chart\Chart $chart, int $relationId = -1) : void
    {
     ...
     * @return string XML Output
     */
    public function writeVMLHeaderFooterImages(\OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet $worksheet) : string
    {
        // Create XML writer
        $objWriter = null;
        if ($this->getParentWriter()->getUseDiskCaching()) {
