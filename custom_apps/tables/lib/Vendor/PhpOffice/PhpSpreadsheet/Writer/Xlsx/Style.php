...
class Style extends WriterPart
{
     ...
     * Write Cell Style Xf.
     */
    private function writeCellStyleXf(XMLWriter $objWriter, \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\Style $style, Spreadsheet $spreadsheet, string $defaultAlignHash) : void
    {
        // xf
        $objWriter->startElement('xf');
        $objWriter->writeAttribute('xfId', '0');
     ...
     */
    private function writeCellStyleDxf(XMLWriter $objWriter, \OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Style\Style $style, Spreadsheet $spreadsheet) : void
    {
        // dxf
