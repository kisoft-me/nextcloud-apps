...
use OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Worksheet\Worksheet as ActualWorksheet;
/** @internal */
class StringTable extends WriterPart
{
    ...
    public function createStringTable(ActualWorksheet $worksheet, ?array $existingTable = null) : array
    {
        ...
        foreach ($worksheet->getCellCollection()->getCoordinates() as $coordinate) {
            ...
            } elseif ($cellValue instanceof RichText && !isset($aFlippedStringTable[$cellValue->getHashCode()])) {
                $aStringTable[] = $cellValue;
