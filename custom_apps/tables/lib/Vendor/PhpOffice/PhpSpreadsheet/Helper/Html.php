...
namespace OCA\Tables\Vendor\PhpOffice\PhpSpreadsheet\Helper;
...
class Html
{
    ...
    public function __construct()
    {
        if (!isset($this->startTagCallbacks)) {
            $this->startTagCallbacks = ['font' => $this->startFontTag(...), 'b' => $this->startBoldTag(...), 'strong' => $this->startBoldTag(...), 'i' => $this->startItalicTag(...), 'em' => $this->startItalicTag(...), 'u' => $this->startUnderlineTag(...), 'ins' => $this->startUnderlineTag(...), 'del' => $this->startStrikethruTag(...), 's' => $this->startStrikethruTag(...), 'sup' => $this->startSuperscriptTag(...), 'sub' => $this->startSubscriptTag(...)];
        }
        if (!isset($this->endTagCallbacks)) {
            $this->endTagCallbacks = ['font' => $this->endFontTag(...), 'b' => $this->endBoldTag(...), 'strong' => $this->endBoldTag(...), 'i' => $this->endItalicTag(...), 'em' => $this->endItalicTag(...), 'u' => $this->endUnderlineTag(...), 'ins' => $this->endUnderlineTag(...), 'del' => $this->endStrikethruTag(...), 's' => $this->endStrikethruTag(...), 'sup' => $this->endSuperscriptTag(...), 'sub' => $this->endSubscriptTag(...), 'br' => $this->breakTag(...), 'p' => $this->breakTag(...), 'h1' => $this->breakTag(...), 'h2' => $this->breakTag(...), 'h3' => $this->breakTag(...), 'h4' => $this->breakTag(...), 'h5' => $this->breakTag(...), 'h6' => $this->breakTag(...)];
        }
    }
    ...
    protected function startFontTag(DOMElement $tag) : void
    {
        ...
        foreach ($attrs as $attribute) {
            ...
            // in case from Xml spreadsheet
            $attributeValue = $attribute->value;
            if ($attributeName === 'color') {
                if (\preg_match('/rgb\\s*\\(/', $attributeValue)) {
                    $this->{$attributeName} = $this->rgbToColour($attributeValue);
                } elseif (\str_starts_with(\trim($attributeValue), '#')) {
