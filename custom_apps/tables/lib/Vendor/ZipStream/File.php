...
namespace OCA\Tables\Vendor\ZipStream;

use Closure;
use DateTimeInterface;
use DeflateContext;
use RuntimeException;
use OCA\Tables\Vendor\ZipStream\Exception\FileSizeIncorrectException;
use OCA\Tables\Vendor\ZipStream\Exception\OverflowException;
use OCA\Tables\Vendor\ZipStream\Exception\ResourceActionException;
use OCA\Tables\Vendor\ZipStream\Exception\SimulationFileUnknownException;
use OCA\Tables\Vendor\ZipStream\Exception\StreamNotReadableException;
use OCA\Tables\Vendor\ZipStream\Exception\StreamNotSeekableException;
/**
 * @internal
 */
class File
