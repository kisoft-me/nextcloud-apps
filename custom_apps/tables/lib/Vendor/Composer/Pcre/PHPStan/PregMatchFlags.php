...
use OCA\Tables\Vendor\PHPStan\Type\ArrayType;
use OCA\Tables\Vendor\PHPStan\Type\Constant\ConstantArrayType;
use OCA\Tables\Vendor\PHPStan\Type\Constant\ConstantIntegerType;
use OCA\Tables\Vendor\PHPStan\Type\IntersectionType;
use OCA\Tables\Vendor\PHPStan\Type\TypeCombinator;
use OCA\Tables\Vendor\PHPStan\Type\Type;
use OCA\Tables\Vendor\PhpParser\Node\Arg;
use OCA\Tables\Vendor\PHPStan\Type\Php\RegexArrayShapeMatcher;
use OCA\Tables\Vendor\PHPStan\Type\TypeTraverser;
use OCA\Tables\Vendor\PHPStan\Type\UnionType;
/** @internal */
