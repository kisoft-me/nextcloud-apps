...
/**
 * Base Class for all \OCA\UserOIDC\Vendor\phpseclib\Crypt\* cipher classes
 *
 * PHP version 5
 *
 * Internally for OCA\UserOIDC\Vendor\phpseclib developers:
 *  If you plan to add a new cipher class, please note following rules:
 *
 *  - The new \OCA\UserOIDC\Vendor\phpseclib\Crypt\* cipher class should extend \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base
 *
 ...
 *
 *  - Look at the source code of the current ciphers how they extend \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base
...
namespace OCA\UserOIDC\Vendor\phpseclib\Crypt;
...
abstract class Base
{
    /**#@+
     * @access public
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::encrypt()
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::decrypt()
     */
    /**
     ...
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::_hashInlineCryptFunction()
     * @var bool
     * @access private
     */
    ...
    /**#@+
     * @access private
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::__construct()
     */
    /**
     ...
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Twofish::setKey()
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Twofish::setIV()
     * @var bool
     * @access private
     */
    var $enchanged = true;
     ...
     * is broken, so OCA\UserOIDC\Vendor\phpseclib implements the CFB mode by it self,
     * even when the mcrypt php extension is available.
     *
     * In order to do the CFB-mode work (fast) OCA\UserOIDC\Vendor\phpseclib
     ...
     *
     * SetIV is not required when self::MODE_ECB (or ie for AES: \OCA\UserOIDC\Vendor\phpseclib\Crypt\AES::MODE_ECB) is being used.  If not explicitly set, it'll be assumed
     * to be all zero's.
     *
     * @access public
     * @param string $iv
    ...
    /**
     * OCA\UserOIDC\Vendor\phpseclib <-> OpenSSL Mode Mapper
     *
     ...
     *
     * Put another way, when the continuous buffer is enabled, the state of the \OCA\UserOIDC\Vendor\phpseclib\Crypt\*() object changes after each
     ...
     *
     * - \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::ENGINE_OPENSSL  [very fast]
     *
     * - \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::ENGINE_MCRYPT   [fast]
     *
     * - \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::ENGINE_INTERNAL [slow]
     *
     ...
     * Encrypts a block
     *
     * Note: Must be extended by the child \OCA\UserOIDC\Vendor\phpseclib\Crypt\* class
     *
     * @access private
     * @param string $in
     * @return string
     ...
     *
     * Note: Must extend by the child \OCA\UserOIDC\Vendor\phpseclib\Crypt\* class
     *
     * @see self::_setup()
     * @access private
     */
     ...
     *       - In case of using inline crypting, _setupInlineCrypt() must extend by the child \OCA\UserOIDC\Vendor\phpseclib\Crypt\* class.
    ...
    {
        // If, for any reason, an extending \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base() \OCA\UserOIDC\Vendor\phpseclib\Crypt\* class
        // not using inline crypting then it must be ensured that: $this->use_inline_crypt = false
        // ie in the class var declaration of $use_inline_crypt in general for the \OCA\UserOIDC\Vendor\phpseclib\Crypt\* class,
     ...
     *    </code>
     *
     *    See also the \OCA\UserOIDC\Vendor\phpseclib\Crypt\*::_setupInlineCrypt()'s for
