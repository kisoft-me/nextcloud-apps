 ...
 *
 *    $des = new \OCA\UserOIDC\Vendor\phpseclib\Crypt\DES();
 *
 *    $des->setKey('abcdefgh');
 *
 *    $size = 10 * 1024;
...
class DES extends Base
{
    /**#@+
     * @access private
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\DES::_setupKey()
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\DES::_processBlock()
     */
    /**
     ...
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::block_size
     * @var int
     * @access private
     */
    var $block_size = 8;
     ...
     * Key Length (in bytes)
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::setKeyLength()
     * @var int
     * @access private
     */
    var $key_length = 8;
     ...
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::cipher_name_mcrypt
     * @var string
     * @access private
     */
     ...
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::openssl_mode_names
     * @var array
     * @access private
     */
     ...
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::cfb_init_len
     * @var int
     * @access private
     */
     ...
     *
     * This is mainly just a wrapper to set things up for \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::isValidEngine()
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::isValidEngine()
     * @param int $engine
     * @access public
     * @return bool
     */
     ...
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::setKey()
     * @access public
     * @param string $key
     */
    function setKey($key)
     ...
     * Encrypts a block
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::_encryptBlock()
     ...
     * Decrypts a block
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::_decryptBlock()
     ...
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::_setupKey()
     * @access private
     */
    function _setupKey()
    {
     ...
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base::_setupInlineCrypt()
     * @access private
     */
