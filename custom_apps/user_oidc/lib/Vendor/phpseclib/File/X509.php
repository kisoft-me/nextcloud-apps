...
namespace OCA\UserOIDC\Vendor\phpseclib\File;

use OCA\UserOIDC\Vendor\phpseclib\Crypt\Hash;
use OCA\UserOIDC\Vendor\phpseclib\Crypt\Random;
use OCA\UserOIDC\Vendor\phpseclib\Crypt\RSA;
use OCA\UserOIDC\Vendor\phpseclib\File\ASN1\Element;
...
class X509
{
    ...
    /**#@+
     * @access public
     * @see \OCA\UserOIDC\Vendor\phpseclib\File\X509::getDN()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \OCA\UserOIDC\Vendor\phpseclib\File\X509::saveX509()
     * @see \OCA\UserOIDC\Vendor\phpseclib\File\X509::saveCSR()
     * @see \OCA\UserOIDC\Vendor\phpseclib\File\X509::saveCRL()
    */
    /**
     * Save as PEM
     *
     ...
     *
     * There's no guarantee \OCA\UserOIDC\Vendor\phpseclib\File\X509 is going to re-encode an X.509 cert in the same way it was originally
     ...
     * Default Constructor.
     *
     * @return \OCA\UserOIDC\Vendor\phpseclib\File\X509
     * @access public
     */
    function __construct()
    {
        ...
        */
        ...
        $AdministrationDomainName = array(
            'type'     => ASN1::TYPE_CHOICE,
            // if class isn't present it's assumed to be \OCA\UserOIDC\Vendor\phpseclib\File\ASN1::CLASS_UNIVERSAL or
            // (if constant is present) \OCA\UserOIDC\Vendor\phpseclib\File\ASN1::CLASS_CONTEXT_SPECIFIC
        ...
        $EDIPartyName = array(
            ...
            'children' => array(
                 ...
                 // partyName is technically required but \OCA\UserOIDC\Vendor\phpseclib\File\ASN1 doesn't currently support non-optional constants and
        ...
        $this->oids = array(
            ...
            // the following are X.509 extensions not supported by OCA\UserOIDC\Vendor\phpseclib
    ...
    function saveX509($cert, $format = self::FORMAT_PEM)
    {
        ...
        /* in the case of policyQualifiers/qualifier, the type has to be \OCA\UserOIDC\Vendor\phpseclib\File\ASN1::TYPE_IA5_STRING.
           \OCA\UserOIDC\Vendor\phpseclib\File\ASN1::TYPE_PRINTABLE_STRING will cause OpenSSL's X.509 parser to spit out random
           characters.
         */
                    ...
                    case 'id-ce-certificatePolicies':
                        for ($j = 0; $j < count($value); $j++) {
                            ...
                            for ($k = 0; $k < count($value[$j]['policyQualifiers']); $k++) {
                                ...
                                $subvalue = &$value[$j]['policyQualifiers'][$k]['qualifier'];
                                if ($map !== false) {
                                    // by default \OCA\UserOIDC\Vendor\phpseclib\File\ASN1 will try to render qualifier as a \OCA\UserOIDC\Vendor\phpseclib\File\ASN1::TYPE_IA5_STRING since it's
                                    // actual type is \OCA\UserOIDC\Vendor\phpseclib\File\ASN1::TYPE_ANY
    ...
    {
        if (!is_string($extnId)) { // eg. if it's a \OCA\UserOIDC\Vendor\phpseclib\File\ASN1\Element object
            return true;
        }
     ...
     *
     * Reformats a public key to a format supported by OCA\UserOIDC\Vendor\phpseclib (if applicable)
     *
     ...
     * Set public key
     *
     * Key needs to be a \OCA\UserOIDC\Vendor\phpseclib\Crypt\RSA object
     *
     * @param object $key
     * @access public
     * @return bool
     ...
     * Gets the public key
     *
     * Returns a \OCA\UserOIDC\Vendor\phpseclib\Crypt\RSA object or a false.
     *
     * @access public
     * @return mixed
     */
    ...
    function saveSPKAC($spkac, $format = self::FORMAT_PEM)
    {
        ...
        switch ($format) {
            ...
            default:
                ...
                // no other SPKAC decoders OCA\UserOIDC\Vendor\phpseclib will use that same format
     ...
     *
     * @param \OCA\UserOIDC\Vendor\phpseclib\File\X509 $issuer
     * @param \OCA\UserOIDC\Vendor\phpseclib\File\X509 $subject
    ...
    function sign($issuer, $subject, $signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        if (isset($subject->domains) && count($subject->domains)) {
            $altName = array_map(array('\OCA\UserOIDC\Vendor\phpseclib\File\X509', '_dnsName'), $subject->domains);
        }
        ...
        // save $tbsCertificate in case there are any \OCA\UserOIDC\Vendor\phpseclib\File\ASN1\Element objects in it
    ...
    function signCSR($signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        // resync $this->signatureSubject
        // save $certificationRequestInfo in case there are any \OCA\UserOIDC\Vendor\phpseclib\File\ASN1\Element objects in it
    ...
    function signSPKAC($signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        // resync $this->signatureSubject
        // save $publicKeyAndChallenge in case there are any \OCA\UserOIDC\Vendor\phpseclib\File\ASN1\Element objects in it
     ...
     *
     * @param \OCA\UserOIDC\Vendor\phpseclib\File\X509 $issuer
     * @param \OCA\UserOIDC\Vendor\phpseclib\File\X509 $crl
     * @param string $signatureAlgorithm optional
     * @access public
     * @return mixed
     */
    function signCRL($issuer, $crl, $signatureAlgorithm = 'sha1WithRSAEncryption')
    {
        ...
        // resync $this->signatureSubject
        // save $tbsCertList in case there are any \OCA\UserOIDC\Vendor\phpseclib\File\ASN1\Element objects in it
        $tbsCertList = $this->currentCert['tbsCertList'];
     ...
     *
     * @param \OCA\UserOIDC\Vendor\phpseclib\File\X509 $key
     * @param string $signatureAlgorithm
     * @access public
     * @return mixed
     */
     ...
     * - Key object
     * - \OCA\UserOIDC\Vendor\phpseclib\File\X509 object with public or private key defined
     * - Certificate or CSR array
     * - \OCA\UserOIDC\Vendor\phpseclib\File\ASN1\Element object
     * - PEM or DER string
     *
    ...
    function computeKeyIdentifier($key = null, $method = 1)
    {
        ...
        switch (true) {
            ...
            case $key instanceof X509:
                ...
                return false;
            default: // Should be a key object (i.e.: \OCA\UserOIDC\Vendor\phpseclib\Crypt\RSA).
     ...
     * of OCA\UserOIDC\Vendor\phpseclib may not be unmapped in the next version, so apps that are looking at this OID may not be able
