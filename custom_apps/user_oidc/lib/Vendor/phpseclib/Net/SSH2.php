 ...
 *
 *    $ssh = new \OCA\UserOIDC\Vendor\phpseclib\Net\SSH2('www.domain.tld');
 ...
 *    include 'vendor/autoload.php';
 *
 *    $key = new \OCA\UserOIDC\Vendor\phpseclib\Crypt\RSA();
...
namespace OCA\UserOIDC\Vendor\phpseclib\Net;

use OCA\UserOIDC\Vendor\phpseclib\Crypt\Base;
use OCA\UserOIDC\Vendor\phpseclib\Crypt\Blowfish;
use OCA\UserOIDC\Vendor\phpseclib\Crypt\Hash;
use OCA\UserOIDC\Vendor\phpseclib\Crypt\Random;
use OCA\UserOIDC\Vendor\phpseclib\Crypt\RC4;
use OCA\UserOIDC\Vendor\phpseclib\Crypt\Rijndael;
use OCA\UserOIDC\Vendor\phpseclib\Crypt\RSA;
use OCA\UserOIDC\Vendor\phpseclib\Crypt\TripleDES;
use OCA\UserOIDC\Vendor\phpseclib\Crypt\Twofish;
use OCA\UserOIDC\Vendor\phpseclib\Math\BigInteger; // Used to do Diffie-Hellman key exchange and DSA/RSA signature verification.
use OCA\UserOIDC\Vendor\phpseclib\System\SSH\Agent;
...
class SSH2
{
     ...
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Net\SSH2::bitmap
     * @access private
     */
     ...
     *     the other side.
     *
     * @see \OCA\UserOIDC\Vendor\phpseclib\Net\SSH2::_send_channel_packet()
     * @see \OCA\UserOIDC\Vendor\phpseclib\Net\SSH2::_get_channel_packet()
     * @access private
    */
    ...
    /**#@+
     * @access public
     * @see \OCA\UserOIDC\Vendor\phpseclib\Net\SSH2::getLog()
    */
    /**
    ...
    /**#@+
     * @access public
     * @see \OCA\UserOIDC\Vendor\phpseclib\Net\SSH2::read()
    */
    /**
    ...
    /**
     * After how many transferred byte should OCA\UserOIDC\Vendor\phpseclib initiate a key re-exchange?
     * 
     * @var int
     * @access private
     */
     ...
     * @param int $timeout
     * @see self::login()
     * @return \OCA\UserOIDC\Vendor\phpseclib\Net\SSH2
     * @access public
     */
    ...
    function _key_exchange($kexinit_payload_server = false)
    {
        ...
        // for OCA\UserOIDC\Vendor\phpseclib initiated key exchanges $send_kex is false
     ...
     * \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base.
     *
     * @param string $algorithm Name of the encryption algorithm
     * @return mixed Instance of \OCA\UserOIDC\Vendor\phpseclib\Crypt\Base or null for unknown
     * @access private
     */
     ...
     * Login
     *
     * The $password parameter can be a plaintext password, a \OCA\UserOIDC\Vendor\phpseclib\Crypt\RSA object or an array
     *
    ...
    function _keyboard_interactive_process()
    {
        ...
        switch ($type) {
            case NET_SSH2_MSG_USERAUTH_INFO_REQUEST:
                ...
                */
                // maybe OCA\UserOIDC\Vendor\phpseclib should force close the connection after x request / responses?  unless something like that is done
     ...
     *
     * @param string $username
     * @param \OCA\UserOIDC\Vendor\phpseclib\System\SSH\Agent $agent
     * @return bool
     * @access private
     */
     ...
     *
     * @param string $username
     * @param \OCA\UserOIDC\Vendor\phpseclib\Crypt\RSA $privatekey
     * @return bool
     * @access private
     * @internal It might be worthwhile, at some point, to protect against {@link http://tools.ietf.org/html/rfc4251#section-9.3.9 traffic analysis}
     *           by sending dummy SSH_MSG_IGNORE messages.
     ...
     * Execute Command
     *
     * If $callback is set to false then \OCA\UserOIDC\Vendor\phpseclib\Net\SSH2::_get_channel_packet(self::CHANNEL_EXEC) will need to be called manually.
    ...
    function exec($command, $callback = null)
    {
        ...
        // down.  the one place where it might be desirable is if you're doing something like \OCA\UserOIDC\Vendor\phpseclib\Net\SSH2::exec('ping localhost &').
     ...
     *
     * \OCA\UserOIDC\Vendor\phpseclib\Net\SSH2 doesn't properly close most channels.  For exec() channels are normally closed by the server
    ...
    /**
     * Returns a list of KEX algorithms that OCA\UserOIDC\Vendor\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of host key algorithms that OCA\UserOIDC\Vendor\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of symmetric key algorithms that OCA\UserOIDC\Vendor\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of MAC algorithms that OCA\UserOIDC\Vendor\phpseclib supports
     *
     * @return array
     * @access public
     */
    ...
    /**
     * Returns a list of compression algorithms that OCA\UserOIDC\Vendor\phpseclib supports
     *
     * @return array
     * @access public
     */
